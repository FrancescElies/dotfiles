...
export module ado {
    ...
    export def "ls machines-usercapabilities" [ has_capability: string = 'Python311' ] {
    ...
    # list prs for year
    export def "ls prs by-year" [year: string] {
    ...
    export def "ls my recent-activity" [] {
        let wiql = [
            $select_from_workitems
