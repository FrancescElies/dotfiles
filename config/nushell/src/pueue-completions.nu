module completions {
  ...
  export alias "pueue server daemonize" = pueued --daemonize -c ('~/src/dotfiles/config/nushell/config/pueue/pueue.yml' | path expand)

  export alias "pueue server foreground" = pueued -c ('~/src/dotfiles/config/nushell/config/pueue/pueue.yml' | path expand)
