...
sys.cpu = require("widgets.systems.cpu")
sys.ram = require("widgets.systems.ram")
sys.battery = require("widgets.systems.battery")
sys.network = require("widgets.systems.network")
sys.disk = require("widgets.systems.disk")
